...
insert into noti (muno, eno, type, date, cont, whom, prno) values (1, 1, "pr", '2017-07-19 15:02:19', "제안받은 이벤트", 'musician', 1);
insert into noti (muno, eno, type, date, cont, whom, prno) values (2, 1, "pr", '2017-07-20 11:52:14', "제안받은 이벤트", 'musician', 2);
insert into noti (muno, eno, type, date, cont, whom, prno) values (3, 2, "pr", '2017-07-28 21:02:18', "제안받은 이벤트", 'musician', 3);
...
insert into noti (muno, eno, type, date, cont, whom, prno) values (3, 2, "pr_accept", '2017-07-21 07:00:15', "요청 수락", 'gmember', 3);
...
insert into noti (muno, eno, type, date, cont, whom, prno) values (3, 4, "pr", '2017-08-02 09:10:52', "제안받은 이벤트", 'musician', 4);
insert into noti (muno, eno, type, date, cont, whom, prno) values (13, 4, "pr", '2017-08-02 09:10:54', "제안받은 이벤트", 'musician', 5);

insert into noti (muno, eno, type, date, cont, whom, prno) values (3, 7, "pr", '2017-08-02 18:18:47', "제안받은 이벤트", 'musician', 6);
insert into noti (muno, eno, type, date, cont, whom, prno) values (14, 7, "pr", '2017-08-02 18:28:38', "제안받은 이벤트", 'musician', 7);
...
insert into noti (muno, eno, type, date, cont, whom, appyno) values (1, 4, "appy", '2017-08-01 23:55:35', "이벤트 지원", 'gmember', 1);
insert into noti (muno, eno, type, date, cont, whom, appyno) values (2, 4, "appy", '2017-08-02 12:45:15', "이벤트 지원", 'gmember', 2);
insert into noti (muno, eno, type, date, cont, whom, appyno) values (3, 4, "appy", '2017-08-03 05:55:35', "이벤트 지원", 'gmember', 3);
insert into noti (muno, eno, type, date, cont, whom, appyno) values (11, 4, "appy", '2017-08-04 11:12:15', "이벤트 지원", 'gmember', 4);

insert into noti (muno, eno, type, date, cont, whom, appyno) values (8, 7, "appy", '2017-08-01 23:38:15', "이벤트 지원", 'gmember', 5);
insert into noti (muno, eno, type, date, cont, whom, appyno) values (14, 7, "appy", '2017-08-03 11:55:19', "이벤트 지원", 'gmember', 6);
...
insert into memb (name, phone, pwd, email) values ('김승원', '010-8011-8145',  password('1111'), 'swkim45@gmail.com');
insert into memb (name, phone, pwd, email) values ('권봉수', '010-2158-2774',  password('1111'), 'bskwon74@gmail.com');
insert into memb (name, phone, pwd, email) values ('김정준', '010-6794-2825',  password('1111'), 'jjkim25@gmail.com');
insert into memb (name, phone, pwd, email) values ('조성규', '010-6966-8468',  password('1111'), 'skjo68@gmail.com');
insert into memb (name, phone, pwd, email) values ('서흥원', '010-3584-9267',  password('1111'), 'hwseo67@gmail.com');
insert into memb (name, phone, pwd, email) values ('김민섭', '010-6380-7728',  password('1111'), 'mskim27@gmail.com');
insert into memb (name, phone, pwd, email) values ('고진서', '010-3131-4735',  password('1111'), 'jsko35@gmail.com');
insert into memb (name, phone, pwd, email) values ('우인재', '010-1507-4856',  password('1111'), 'ijwoo56@gmail.com');
insert into memb (name, phone, pwd, email) values ('김대연', '010-2352-7818',  password('1111'), 'dykim18@gmail.com');
insert into memb (name, phone, pwd, email) values ('홍효선', '010-6259-3698',  password('1111'), 'hshong98@gmail.com');
insert into memb (name, phone, pwd, email) values ('신용주', '010-1067-2164',  password('1111'), 'yjshin64@gmail.com');
insert into memb (name, phone, pwd, email) values ('정성룡', '010-9854-4371',  password('1111'), 'srjeong71@gmail.com');
insert into memb (name, phone, pwd, email) values ('이수은', '010-9747-9174',  password('1111'), 'selee74@gmail.com');
insert into memb (name, phone, pwd, email) values ('김미연', '010-2896-0997',  password('1111'), 'mykim97@gmail.com');
insert into memb (name, phone, pwd, email) values ('신선아', '010-2636-1407',  password('1111'), 'sashin07@gmail.com');
insert into memb (name, phone, pwd, email) values ('이유운', '010-8288-9173',  password('1111'), 'uolee73@gmail.com');
insert into memb (name, phone, pwd, email) values ('홍순민', '010-1321-6523',  password('1111'), 'smhong23@gmail.com');
insert into memb (name, phone, pwd, email) values ('조현', '010-2850-4278',  password('1111'), 'hyeon76@gmail.com');
insert into memb (name, phone, pwd, email) values ('김재승', '010-1186-8031',  password('1111'), 'jskim31@gmail.com');
insert into memb (name, phone, pwd, email) values ('이재홍', '010-4182-7444',  password('1111'), 'jhlee44@gmail.com');
insert into memb (name, phone, pwd, email) values ('김나영', '010-2491-3828',  password('1111'), 'nykim28@gmail.com');
