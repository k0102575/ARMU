...
$(".sub-category-menu").click(function(event){
  var clickDiv = event.currentTarget.innerText
    $("#theme-category").toggle("slide", {direction:"down"}, 600, function(){
      $('#logo-img').attr('src', '');
      $('#header-menu-logo').html(clickDiv);
    });
})
