...
insert into musi (muno, age, team, hpg, intro, path) values (1, 35, 0, 'http://tistory.seungwoo.com', '저는 짱짱맨 조승우입니다. 조각같은 외모와 매력적인 목소리로 당신의 이벤트를 아름답게 만들어드리겠습니다!', 'mobile/musician/photo/0choi2.jpg');
insert into musi (muno, age, team, hpg, intro, path) values (2, 34, 0, 'http://tistory.jhlee.com', '안녕하세요. 임정희입니다. 저로 말할 것 같으면, 화려한 외모와 옥구슬같은 목소리로 당신의 이벤트를 아름답게 만들어드리겠습니다!', 'mobile/musician/photo/m1.jpg');
insert into musi (muno, age, team, hpg, intro, path) values (3, 28, 1, 'http://tistory.ohora.com', '저희 오호라 밴드는 다른 아마추어 팀들과는 차원이 다른 프로 밴드 그 이상의 실력으로 감동을 드리는 밴드입니다. 다재다능한 팀원들과 5년간 호흡을 맞춰 각종 공연을 많이 해봤습니다. 언제든 알뮤를 통해 연락주세요!!', 'mobile/musician/photo/m2.jpg');
